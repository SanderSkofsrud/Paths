...
public class FinalPassageView extends View {
   ...
   */
  private static final String CREDITS_TEXT = "creditsText";
  ...
  public void setup() {
    ...
    Text congratsText = new Text(languageController
        .getTranslation(Dictionary.CREDITS_TEXT_1.getKey())
        + "\n" + languageController.getTranslation(Dictionary.CREDITS_TEXT_1_1.getKey()));
    congratsText.setId("creditsHeader");

    Text goalsTitle = new Text(languageController.getTranslation(Dictionary
        .CREDITS_TEXT_2.getKey()));
    goalsTitle.setId("creditsHeader");

    Text goalsAchieved = new Text(languageController.getTranslation(Dictionary
    ...
    goalsFailed.setId(CREDITS_TEXT);
    ...
    Text createdByText = new Text(languageController.getTranslation(Dictionary
        .CREDITS_TEXT_3.getKey())
        + "\n" + languageController.getTranslation(Dictionary.CREDIT_TEXT_3_1.getKey()));
    createdByText.setId(CREDITS_TEXT);

    Text specialThanksText = new Text(languageController.getTranslation(Dictionary
        .CREDITS_TEXT_4.getKey())
    ...
    specialThanksText.setId(CREDITS_TEXT);

    Text sourcesText = new Text(languageController.getTranslation(Dictionary
        .CREDITS_TEXT_5.getKey())
    ...
    sourcesText.setId(CREDITS_TEXT);

    Text imagesText = new Text(languageController.getTranslation(Dictionary
        .CREDITS_TEXT_6.getKey())
    ...
    imagesText.setId(CREDITS_TEXT);

    Text thankYouText = new Text(languageController.getTranslation(Dictionary
        .CREDITS_TEXT_7.getKey()));
    thankYouText.setId(CREDITS_TEXT);
